...
stormBtn.addEventListener("click", function makeStorm(event) {
  makeRain = 1;
...
bd.addEventListener("click", function stopRain(event) {
  xPos.length = 0;
  yPos.length = 0;
  ...
  if (makeRain == 1) {
    ...
    for (var cloudWho = 0; cloudWho < 5; cloudWho++) {
      if (cloudDownEnabler[cloudWho] == 1) {
        ...
        ctx.beginPath();
        ctx.arc(-40 + posCenter + cloudWho * c.width * 1 / 5, -10 + cloudDownDo[cloudWho], 22, 0 * Math.PI, 2 * Math.PI);
        ctx.arc(-20 + posCenter + cloudWho * c.width * 1 / 5, -10 + cloudDownDo[cloudWho], 27, 0 * Math.PI, 2 * Math.PI);
        ctx.arc(posCenter + cloudWho * c.width * 1 / 5, -10 + cloudDownDo[cloudWho], 32, 0 * Math.PI, 2 * Math.PI);
        ctx.arc(+20 + posCenter + cloudWho * c.width * 1 / 5, -10 + cloudDownDo[cloudWho], 27, 0 * Math.PI, 2 * Math.PI);
        ctx.arc(+40 + posCenter + cloudWho * c.width * 1 / 5, -10 + cloudDownDo[cloudWho], 25, 0 * Math.PI, 2 * Math.PI);
